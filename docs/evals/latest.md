...
- Overall: **94.04** (pass)
- Operational: **94.04**
- Scores: completeness=96.4, diversity=100.0, summary=100.0, freshness=93.8, retrieval=85.0, section_fit=96.9, core=92.8, commodity=86.7
- Briefing cards: 19 / Commodity cards: 27
- Sections: supply:5/5 raw=230, policy:5/5 raw=155, dist:4/5 raw=92, pest:5/5 raw=75
- Metrics: title_unique=1.00, domain_diversity=0.84, summary_presence=1.00, summary_numeric=0.89, fresh_72h=1.00, fit_avg=4.34, false_positive=0.00, weak_core=0.14, editorial_penalty=0.5, commodity_weak=0.00, commodity_coverage=0.24, commodity_strict_link=0.75, commodity_false_link=0.12, commodity_dominant_section=0.62, semantic_penalty=0.0
