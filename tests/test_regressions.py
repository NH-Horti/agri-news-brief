...
class TestRegressions(unittest.TestCase):
    ...
    def test_daily_workflow_runs_eval_harness_and_feedback_loop(self):
        ...
        self.assertIn("EDITORIAL_OPENAI_MODEL: gpt-5.5", self.daily_text)
        self.assertIn("EDITORIAL_OPENAI_MODEL: gpt-5.5", self.rebuild_text)
        self.assertIn('echo "- Article generation model: gpt-5.5"', self.daily_text)
        self.assertIn('echo "- Editorial evaluation model: gpt-5.5"', self.daily_text)
        self.assertIn('echo "- Article generation model: gpt-5.5"', self.rebuild_text)
        self.assertIn('echo "- Editorial evaluation model: gpt-5.5"', self.rebuild_text)
