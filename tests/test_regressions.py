...
class TestRegressions(unittest.TestCase):
    ...
    def test_daily_workflow_runs_eval_harness_and_feedback_loop(self):
        ...
        self.assertIn('OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-5.5")', self.text)
        self.assertIn("OPENAI_MODEL: gpt-5.5", self.daily_text)
        self.assertIn("OPENAI_MODEL: gpt-5.5", self.rebuild_text)
        self.assertIn("OPENAI_MODEL: gpt-5.5", self.maintenance_text)
        self.assertIn("EDITORIAL_OPENAI_MODEL: gpt-5.5-2026-04-23", self.daily_text)
        self.assertIn("EDITORIAL_OPENAI_MODEL: gpt-5.5-2026-04-23", self.rebuild_text)
        self.assertIn('echo "- Article generation model: gpt-5.5"', self.daily_text)
        self.assertIn('echo "- Editorial evaluation model: gpt-5.5-2026-04-23"', self.daily_text)
        self.assertIn('echo "- Article generation model: gpt-5.5"', self.rebuild_text)
        self.assertIn('echo "- Editorial evaluation model: gpt-5.5-2026-04-23"', self.rebuild_text)
