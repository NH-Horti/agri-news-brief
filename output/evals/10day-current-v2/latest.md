...
- Overall: **81.88** (warn)
- Scores: completeness=100.0, diversity=100.0, summary=100.0, freshness=100.0, retrieval=85.0, section_fit=80.4, core=99.8, commodity=91.3
- Briefing cards: 17 / Commodity cards: 71
- Sections: supply:5/3 raw=168, policy:4/3 raw=162, dist:3/3 raw=43, pest:5/3 raw=30
- Metrics: title_unique=1.00, domain_diversity=0.94, summary_presence=1.00, summary_numeric=1.00, fresh_72h=1.00, fit_avg=4.12, false_positive=0.12, weak_core=0.00, commodity_weak=0.00, semantic_penalty=14.1
