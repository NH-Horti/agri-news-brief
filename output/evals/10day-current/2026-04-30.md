...
- Overall: **88.72** (pass)
- Scores: completeness=100.0, diversity=100.0, summary=100.0, freshness=100.0, retrieval=86.2, section_fit=81.0, core=86.5, commodity=94.1
- Briefing cards: 18 / Commodity cards: 96
- Sections: supply:5/3 raw=197, policy:4/3 raw=131, dist:4/3 raw=45, pest:5/3 raw=64
- Metrics: title_unique=1.00, domain_diversity=0.83, summary_presence=1.00, summary_numeric=0.78, fresh_72h=1.00, fit_avg=2.53, false_positive=0.06, weak_core=0.25, commodity_weak=0.00, semantic_penalty=6.7
