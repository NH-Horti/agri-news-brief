...
- Overall: **87.31** (pass)
- Operational: **91.67**
- Reader quality: **87.31** (capped; penalty=4.4, cap=88.0, reasons=story_duplicate)
- Scores: completeness=100.0, diversity=95.0, summary=98.5, freshness=100.0, retrieval=85.2, section_fit=97.2, core=91.8, commodity=92.0
- Briefing cards: 20 / Commodity cards: 14
- Sections: supply:5/5 raw=205, policy:5/5 raw=75, dist:5/5 raw=44, pest:5/5 raw=25
- Metrics: title_unique=0.95, domain_diversity=0.65, summary_presence=1.00, summary_numeric=0.75, fresh_72h=1.00, fit_avg=3.65, false_positive=0.00, hard_reader_issues=0, weak_core=0.17, editorial_penalty=0.2, commodity_weak=0.00, commodity_items=6, commodity_coverage=0.18, commodity_strict_link=1.00, commodity_false_link=0.00, commodity_dominant_section=0.67, semantic_penalty=0.0
